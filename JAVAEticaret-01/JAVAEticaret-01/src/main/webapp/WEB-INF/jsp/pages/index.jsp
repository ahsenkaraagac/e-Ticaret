...
<html lang="en">
	<head>
		...
		<%--&lt;%&ndash;<link rel="stylesheet" href="<c:url value="/resources/css/bootstrap.min.css"/>"/>&ndash;%&gt;--%>
		...
		<%--<link href="/jsp/UI-Pages/Theme/themes/css/main.css" rel="stylesheet"/>--%>
				...
				<%--<div class="span8">--%>
					<%--<div class="account pull-right">--%>
						<%--<ul class="user-menu">				--%>
							...
							<%--<li><a href="/UI/cart">Your Cart</a></li>--%>
							<%--<li><a href="/UI/cehck">Checkout</a></li>--%>
							<%--<li><a href="/UI/register">Login</a></li>--%>
						<%--</ul>--%>
					<%--</div>--%>
				<%--</div>--%>
			<%--</div>--%>
									...
									<div class="carousel-inner">
											...
											<ul class="thumbnails">												
												<li class="span3">
													<div class="product-box">
														...
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/1.jpg" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/2.jpg" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/3.jpg" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/4.jpg" alt="" /></a></p>
										...
										<div class="item">
											<ul class="thumbnails">
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/5.jpg" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/6.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Ut wisi enim ad</a><br/>
														<a href="products.jsp" class="category">Commodo consequat</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/7.jpg" alt="" /></a></p>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/ladies/8.jpg" alt="" /></a></p>
									...
									<div class="carousel-inner">
										<div class="active item">
											<ul class="thumbnails">												
												<li class="span3">
													<div class="product-box">
														<span class="sale_tag"></span>
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware2.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Ut wisi enim ad</a><br/>
														<a href="products.jsp" class="category">Commodo consequat</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware1.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Quis nostrud exerci tation</a><br/>
														<a href="products.jsp" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware6.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Know exactly turned</a><br/>
														<a href="products.jsp" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware5.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">You think fast</a><br/>
														<a href="products.jsp" class="category">World once</a>
										...
										<div class="item">
											<ul class="thumbnails">
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware4.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Know exactly</a><br/>
														<a href="products.jsp" class="category">Quis nostrud</a>
												...
												<li class="span3">
													<div class="product-box">
														<p><a href="product_detail.jsp"><img src="/resources/themes/images/cloth/bootstrap-women-ware3.jpg" alt="" /></a></p>
														<a href="product_detail.jsp" class="title">Ut wisi enim ad</a><br/>
														<a href="products.jsp" class="category">Commodo consequat</a>
			...
			<section id="footer-bar">
				<div class="row">
					<div class="span3">
						<h4>Navigation</h4>
						<ul class="nav">
							<li><a href="/UI/index">Homepage</a></li>
							<li><a href="./about.html">About Us</a></li>
							<li><a href="/UI/contact">Contac Us</a></li>
							<li><a href="/UI/cart">Your Cart</a></li>
							<li><a href="/UI/register">Login</a></li>
						</ul>
					</div>s
